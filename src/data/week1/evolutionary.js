...
Η φυσική επιλογή αναφέρεται στη διαδικασία μέσω της οποίας χαρακτηριστικά που βοηθούν στην επιβίωση και αναπαραγωγή διατηρούνται με την πάροδο του χρόνου.`.trim(),
  ...
  /** Αντίθεση με «άγραφο πίνακα» */
  lectureVsTabulaRasa: `Στη διάλεξη τονίζεται ότι η εξελικτική ψυχολογία εξηγεί νου και συμπεριφορά με βάση την προσαρμοστική αξία ικανοτήτων που διατηρήθηκαν μέσω φυσικής επιλογής — σε αντίθεση με την ιδέα ότι «γεννιόμαστε λευκοί πίνακες»: υποστηρίζονται έμφυτες ψυχολογικές προδιαθέσεις (π.χ. φόβος κινδύνου, ανάγκη δεσμού, ελκυστικοί σύντροφοι, τάση συνεργασίας), με ρίζες στη θεωρία του Δαρβίνου (επιβίωση, ζευγάρωμα, τροφή, αναπαραγωγή).`.trim(),
  ...
  progressChecklist: [
    ...
    'Ξέρω τη μελέτη συμπεριφοράς σε επίπεδο είδους',
...
export const evolutionaryExamQuestions = [
  {
    ...
    idealAnswer: `Η Εξελικτική Ψυχολογία μελετά τη συμπεριφορά και τις νοητικές διεργασίες με βάση τις αρχές της εξέλιξης, της φυσικής επιλογής και της προσαρμογής· μελετά επίσης την αλλαγή της συμπεριφοράς στα έμβια όντα κατά την εξέλιξη του είδους.`,
  },
  {
...
const rawEvolutionaryMcq = [
  ...
  {
    question: 'Η εξελικτική ψυχολογία μελετά επίσης:',
    options: [
    ...
    explanation: 'Αυτό αναφέρεται ρητά στο υλικό για την εξελικτική ψυχολογία.',
  },
]
