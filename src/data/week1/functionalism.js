/**
 * Εβδομάδα 1 — Λειτουργισμός / William James (PSD115)
 */
...
export const functionalismLesson = {
  ...
  /** Λειτουργισμός → εφαρμοσμένα πεδία */
  appliedInLecture: `Στο πλαίσιο του λειτουργισμού πολλοί ψυχολόγοι ενδιαφέρθηκαν για ατομικές διαφορές στη μάθηση και στις μνημονικές ικανότητες — θεμελίωσαν την κατεύθυνση μέτρησης της νοημοσύνης. Ο James συνδέεται επίσης με την εφαρμοσμένη ψυχολογία: ενδιαφέρον για ψυχική υγεία (νοσοκομεία / ιδρύματα) και με την ίδρυση της εκπαιδευτικής ψυχολογίας στις ΗΠΑ.`.trim(),
  ...
  keyPoints: [
    ...
    'Βάση για μέτρηση νοημοσύνης / ατομικές διαφορές (διάλεξη)',
    'Εφαρμοσμένη ψυχολογία: ψυχική υγεία, εκπαιδευτική ψυχολογία ΗΠΑ (James, διάλεξη)',
  ],
