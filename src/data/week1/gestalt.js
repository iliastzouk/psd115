...
Αντίληψη · οργάνωση εμπειρίας`.trim(),
  ...
  /** Συνέχεια διάλεξης K1 (μετά το πείραμα Köhler με τις μπανάνες) */
  kohlerInsightLecture: `Σύμφωνα με την προφορική παρουσίαση: οι χιμπαντζήδες στο πείραμα του Köhler δεν δοκίμαζαν τυχαία κινήσεις· αντιλαμβάνονταν τη συνολική δομή του προβλήματος («το σύνολο είναι περισσότερο από το άθροισμα των μερών») και η λύση μπορούσε να εμφανιστεί ως ξαφνική ενόραση (insight).`.trim(),

  keyPoints: ['Gestalt', 'Αντίληψη', 'Οργάνωση εμπειρίας', 'Το όλο', 'Μορφές και πρότυπα', 'Köhler: ενόραση / δομή προβλήματος (διάλεξη)'],
