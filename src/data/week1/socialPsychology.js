...
Κοινωνική συμπεριφορά · κοινωνική γνώση · Milgram (1963)`.trim(),
  ...
  theory: `Η Κοινωνική Ψυχολογία ασχολείται με τα αίτια και τις επιπτώσεις των διαπροσωπικών συμπεριφορών· αναγνωρίζει ότι οι άνθρωποι είναι κοινωνικά όντα (οικογένεια, φίλοι, σχολείο, εργασία). Μελετά πώς η κοινωνία επηρεάζει τη συμπεριφορά και πώς διαμορφώνεται η κοινωνική γνώση — συμπεριλαμβανομένων στρατηγικών κοινωνικής επιρροής (όπως στην προφορική διάλεξη K1).`.trim(),
...
• Τι είναι ο ρατσισμός και πώς αναπτύσσεται;`.trim(),
  ...
  racism: `Η κοινωνική ψυχολογία μελετά ζητήματα όπως ο ρατσισμός και ο τρόπος ανάπτυξής του. Στη διάλεξη: για επιθετικότητα, ο κοινωνικός ψυχολόγος θα εξέταζε και πολιτισμικές επιδράσεις (διαφορετικές κοινωνίες διαχειρίζονται την επιθετικότητα διαφορετικά) και ρόλο μέσων (π.χ. τηλεόραση, ραδιόφωνο).`.trim(),

  aschTitle: 'Πείραμα Asch (1958)',

  asch: `Το πείραμα του Asch (1958) μελέτησε την κοινωνική επιρροή και τη συμμόρφωση: σε εργασία σύγκρισης μήκους γραμμών, όταν η πλειοψηφία της ομάδας (συνωμοσία του πειράματος) έδινε φανερά λανθασμένη απάντηση, πολλοί συμμετέχοντες συμμορφώνονταν προς την ομάδα ακόμη κι όταν ήξεραν τη σωστή απάντηση (όπως στην προφορική διάλεξη). Στη μεταγραφή εμφανίζεται λανθασμένα ως «Ντουάζ» — το σωστό όνομα είναι Asch.`.trim(),

  milgramTitle: 'Πείραμα Milgram (1963)',

  milgram: `Το πείραμα του Milgram μελέτησε την υπακοή στην εξουσία: «δάσκαλος» και «μαθητής» (ηθοποιός) σε ξεχωριστά δωμάτια· ψεύτικο μηχάνημα ηλεκτροσόκ με κλιμακούμενα επίπεδα· όταν ο πειραματιστής ως φιγούρα εξουσίας ζητούσε να συνεχιστεί, στατιστικά σημαντικό ποσοστό συμμετεχόντων έφτανε σε πολύ υψηλά «επίπεδα» (στη διάλεξη αναφέρεται ~62%) — δηλαδή πολλοί υπάκουαν σε εντολή που ένιωθαν ανήθικη. Στη μεταγραφή εμφανίζεται λανθασμένα ως «Μίλτρα» — το σωστό όνομα είναι Milgram.`.trim(),
