/**
 * Εβδομάδα 1 — Δομισμός / Wilhelm Wundt (PSD115 · PPT-first)
 */
...
export const wundtLesson = {
  ...
  introspection: `Η ενδοσκόπηση ήταν πειραματική μέθοδος: μετά από ερεθίσματα (π.χ. λέξεις ή ήχους) οι συμμετέχοντες κατέγραφαν την υποκειμενική τους εμπειρία — συχνά την πρώτη λέξη ή ιδέα που προέκυπτε, και στη συνέχεια ανέλυαν αισθήσεις, συναισθήματα και εσωτερικές εικόνες (όπως στην προφορική παρουσίαση του K1).`.trim(),
