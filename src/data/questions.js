...
export const flashcards = [
  {
    ...
    front: 'Τι μελετά η Ψυχολογία ως επιστήμη;',
    back: 'Περιγράφει και εξηγεί τη συμπεριφορά και τις νοητικές διεργασίες κυρίως του ανθρώπου, αλλά και άλλων έμβιων όντων.',
  },
  {
    id: 'fc-def-2',
    categoryId: 'definition',
    front: 'Τι εννοούμε με τον όρο «συμπεριφορά»;',
    back: 'Δραστηριότητα που μπορεί να παρατηρηθεί από άλλους οργανισμούς ή από τα μηχανήματα ενός πειραματιστή.',
  },
  {
    id: 'fc-def-3',
    categoryId: 'definition',
    front: 'Τι εννοούμε με τον όρο «νους» σε ψυχολογικό πλαίσιο;',
    back: 'Η εσωτερική εμπειρία των αντιλήψεων, σκέψεων, αναμνήσεων και συναισθημάτων.',
  },
  {
    id: 'fc-hist-1',
    categoryId: 'history',
