...
const links = [
  ...
  { to: '/week/1/skinner', label: 'Skinner' },
  { to: '/week/1/cognitive', label: 'Γνωστική' },
  { to: '/week/1/chomsky', label: 'Chomsky' },
  { to: '/week/1/neuroscience', label: 'Νευρο' },
  { to: '/week/1/gestalt', label: 'Gestalt' },
  { to: '/week/1/evolutionary', label: 'Εξέλιξη' },
  { to: '/week/1/social-psychology', label: 'Κοινωνική' },
  { to: '/week/1/educational-psychology', label: 'Εκπαίδευση' },
  { to: '/week/1/other-branches', label: 'Κλάδοι' },
