...
export default function Week4SubNav() {
  ...
  return (
    <nav className="space-y-2.5" aria-label="Εβδομάδα 4 — πλοήγηση">
      <div>
